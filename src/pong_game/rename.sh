...
shopt -s extglob #https://www.tecmint.com/delete-all-files-in-directory-except-one-few-file-extensions/ describes how this works
rm -vrf -- !($game_binary|$game_description) 
mv $game_binary $game_name
